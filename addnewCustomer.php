...
<body>
	<div class="topnav">
      ...
      <a class="active" href="addNewCustomer.php">Add new Customer</a>
	...
	<form action="addCustomerphpCode.php">
	<table>
		<th >
		...
		<tr>
			<td style="padding: 5%;">
				<b>Customer Name</b> <input type="text" name="customerName" required>
