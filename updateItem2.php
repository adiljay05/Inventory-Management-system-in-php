...
<body>
	...
	<table>
        ...
        <?php
            ...
            $q="select itemId,itemName from Items where itemId='$itemId'";
            $result=mysqli_query($con,$q);
            if ($result->num_rows > 0) {
              //output data of each row
              while($row = $result->fetch_assoc()) {
                echo "<b>Item ID:&nbsp;&nbsp;</b>". "<font name=\"itemId\">".$row["itemId"]."</font>" .  "<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Item Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>". $row["itemName"];
              }
            }
            else{
